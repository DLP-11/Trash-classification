...
def train(epochs):
    begin_time = time()
    train_ds, val_ds, class_names = data_load("D:/project/trash_jpg/trash_jpg_rename", 224, 224, 16)
    print(class_names)
    ...
    print('The cycle program runs time:', run_time, "s")  # 该循环程序运行时间： 1.4201874732
