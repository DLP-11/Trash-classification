...
def img_resize_by_height(src_img_path, target_height=400):
    '''
    :param src_img_path: 图片路径
    :param target_height: 可任意更改
    :return: none
    :功能 将图片大小转换为 target_height * target_height 尺寸
    '''
...
if __name__ == '__main__':
    src_data_folder = "D:/code/trash_jpg_renamed"
    target_data_folder = "D:/code/trash_jpg_renamed_new"
